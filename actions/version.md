...
**Upstream**: https://raw.githubusercontent.com/Bob-moret/do-work/main/actions/version.md
...
To update, run:
npx skills add Bob-moret/do-work -g -y
```
...
Or visit: https://github.com/Bob-moret/do-work
```
